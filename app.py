...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif; user-select: none; }
        body { background-color: #121212; color: #E0E0E0; display: flex; justify-content: center; min-height: 100vh; padding: 16px; }
        ...
        .footer { margin-top: auto; text-align: center; font-size: 12px; color: #424242; padding-bottom: 8px; }
    </style>
</head>
<body>
    <div class="container">
